  ...
  return (
    <div className="space-y-8">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-5">
        <div
          className={`rounded-xl flex items-center justify-between border border-gray-300 p-5 bg-white ${path !== "/" && "border-b-2 border-b-violet-600"
            }`}
        >
        ...
        {Socials.map((app: any) => {
          return (
            <Link
              ...
              target="_blanck"
              key={app.id}
              className="rounded-md border bg-white border-gray-300 text_color p-2 flex gap-2 pr-3"
            >
